...
create table House
	(
		...
		FOREIGN KEY(owner_id)
	  		REFERENCES House_Owner(owner_id)
	);
...
create table Student
	...
	FOREIGN KEY(degree_id)
	  		REFERENCES Degree_enum(degree_id)
	);
...
INSERT INTO Student VALUES (238, 'lrjv21cqvk@gmail.com', 'zwjx', 'oqqyck', '1241234664256', 'm', 'qnxud', 'CSE', 'NV', 'eedu', 'm', 3,'xyzpw');
